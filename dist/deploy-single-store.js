...
import { buildHelpTableData } from "./ui/ink-logger.js";
import { red } from "./ui/logging.js";
export class StoreValidationError extends Error {
    helpTables;
    constructor(message, helpTables, cause) {
        super(message);
...
export function deployStore(options, storeName, context) {
    ...
    if (!parseResult.success) {
        ...
        if (structuralIssues.length > 0) {
            const failedFields = [...new Set(structuralIssues
